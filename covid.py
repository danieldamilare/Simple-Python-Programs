...
variable = {
    # 'red_daily_contacts': fixed['init_contacts'],
...
contact_slider = Slider(contacts_ax,  # axes object containing the slidder
                        'reduced\ncontacts/day', # name of slider
                        0,   #minimal value of the parameter
                        50, # maximum value of the parameter
                        50  # initial value of the parameter)
                        )
contact_slider.label.set_fontsize(12)
...
slider_update = lambda _: update(fixed, infection_plot, txt_box,
                                 contact_slider, start_day_slider,
                                 end_day_slider)
contact_slider.on_changed(slider_update)
